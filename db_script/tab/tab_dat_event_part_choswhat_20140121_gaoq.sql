...
CREATE TABLE  `yuefanju`.`dat_event_part_choswhat` (
  ...
  `event_participant_id` varchar(20)  NOT NULL COMMENT '活动参与者',
  `event_what_select` varchar(5)  NOT NULL COMMENT '活动参与者活动内容选择',
  PRIMARY KEY (`event_id`,`event_participant_id`,`event_what_select`)
